    ...
    <div class="bg-[#f7f7f9] py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="text-xs text-gray-500 mb-4">
                ...
                <a href="{{ route('account.address.index') }}" class="hover:text-[#8f6a10]">Addresses</a>
                <span class="mx-1">/</span>
                <span class="text-gray-400">Add New</span>
            </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <main class="lg:col-span-3 space-y-5">
                    ...
                    <section class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                        ...
                        <form method="POST" action="{{ route('account.address.store') }}" class="space-y-4">
                            @csrf
